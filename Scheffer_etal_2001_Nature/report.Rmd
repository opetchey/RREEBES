...
A folded relationship between environmental conditions ($a$) and ecosystem state ($x$), produced by a relatively high value of $p$, with two ways of shifting between the alternate states. One way as the environmental condition increases from low to high, and the other as the environmental conditions decreases from high to low.
