...
basins <- lapply(1:nrow(initial_condition), function(x) ode(y = as.numeric(initial_condition[x, ]), times = 1:2000, func = r_star_5))
...
result <- lapply(basins, comp_out, time = 2000, biomass_threshold = 5)
...
basins2 <- parLapply(cl, 1:25, function(x) {r_star_5_par(x, time_steps, resolution)})
...
str(out)
save(basins2, file = "/Users/frank/Documents/Git projects/RREEBES/Huisman_Weissing_2001/basins2.RData")
