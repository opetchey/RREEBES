---
title: Yampolsky et al. (2015) Adaptive phenotypic plasticity and local adaptation
...
getTable4 <- function(data, aht){
  ...
  print(xtable(glmH576Table), floating.placement='!', comment=FALSE)  
}
