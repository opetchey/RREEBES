...
To make the prediction about what happens next (i.e., the value of the green data point in the first graph), we use what happened just after the similar dynamics occured in the past. In the following graph, the green data points are the values that follow each of closely matching the past dynamics.
