...
# WARNING: only load dplyr package after model fitting
# due to clashes with tsDyn package
...
dat <- ts[!(ts$ID %in% c(428, 482, 430,514,515,590,1234)),]
#dat <- ts
...
for(w in setdiff(1:numRec, c(428, 482, 430,514,515,590,1234))){
...
save.image("Ward_et_al_results.RData")
```
