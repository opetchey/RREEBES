...
fig2b_comparative <- fig2_base + geom_point(inherit.aes = F, data=mean_pred_per_NED, aes(x=NED, y=mean_comparative), color="red ",shape=2, size=3) + 
  geom_errorbar(inherit.aes = F, data=mean_pred_per_NED, aes(x=NED, ymin=mean_comparative-sd_comparative, ymax=mean_comparative+sd_comparative), color="red")

fig2c_multiplicative <- fig2_base + geom_point(inherit.aes = F, data=mean_pred_per_NED, aes(x=NED, y=mean_multiplicative), color="red ")
fig2d_additive <- fig2_base + geom_point(inherit.aes = F, data=mean_pred_per_NED, aes(x=NED, y=mean_additive), color="red ")
