...
Known issues with this reproduction are [here](https://github.com/opetchey/RREEBES/issues). Please submit any issues there.
...
```{r, echo=FALSE}
#tr <- read.csv("~/Dropbox (Dept of Geography)/RREEBES/Beninca_etal_2008_Nature/data/transformed_data_Nature2008.csv", skip=7, na.string="")

tr <- read.csv(text=getURL("https://raw.githubusercontent.com/opetchey/RREEBES/boost_by_owen/Beninca_etal_2008_Nature/data/transformed_data_Nature2008.csv"),
               skip=7, na.string="")
...
two.datasets <- merge(tr, final, all=T)
...
## rather, read the data file from your local copy
load("~/Desktop/git/RREEBES/Beninca_etal_2008_Nature/data/GLE_estimate.Rdata")

## would be nice to load directly from github, but this not working
#download.file("https://github.com/opetchey/RREEBES/raw/Beninca_cleaning/Beninca_etal_2008_Nature/data/GLE_estimate.Rdata", "myfile", method="curl")
#load("myfile")
