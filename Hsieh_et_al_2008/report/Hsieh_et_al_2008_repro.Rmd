...
sp5_observations  <- simplex_mod_pred_sp5_2[[4]]$model_output$obs[500:999]
sp5_predictions  <- simplex_mod_pred_sp5_2[[4]]$model_output$pred[500:999]

# compare data with predictions visually
plot(five_sp_comp$time, five_sp_comp$species.5, "l", ylim=c(0,1), xlim = c(900,1000))
par(new=T)
plot(five_sp_comp$time, sp5_predictions, "l", lty = 2, col="red", ylim=c(0,1), xlim = c(900,1000))
...
sp5_observations  <- smap_pred[[1]]$model_output$obs[500:999]
sp5_predictions  <- smap_pred[[1]]$model_output$pred[500:999]
...
sp3_observations  <- block[[1]]$model_output$obs[500:999]
sp3_predictions  <- block[[1]]$model_output$pred[500:999]
