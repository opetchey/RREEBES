...
# fit AR(4) model
ar_mod <-  ar(as.ts(five_sp_comp[,c(3)]), FALSE, 4)
str(ar_mod)
...
sp3_ar_prediction[t] = ar_mod$ar[1] * five_sp_comp[t-1,3] + ar_mod$ar[2] * five_sp_comp[t-2,3]  + ar_mod$ar[3] * five_sp_comp[t-3,3] + ar_mod$ar[4] * five_sp_comp[t-4,3]

}

sp3_pred <- predict(ar_mod)
str(sp3_pred)
