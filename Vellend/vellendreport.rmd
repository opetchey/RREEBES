...
Same analyses where carried for eveness and diversity except for the evaluation of predictor variables, which was omitted due to small sample size. Analyses where done with OepnBUGS in R package, but we will attempt them with the "metafor" package. 
