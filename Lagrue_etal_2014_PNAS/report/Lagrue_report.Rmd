...
# it displays NAs for some entries that we know to be zero. Confusing!
# we should be able to discern zeroes from NAs automatically. Given the small matrix we can eyeball it:
