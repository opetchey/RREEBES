...
#read in data
prod <- read.csv("C:\\Users\\carol\\Desktop\\carol\\NCEAS\\Cardinale WG\\Relative importance\\Meta-analyses\\Production\\ProdBoot.csv", check.names=FALSE)
head(prod)

#subset for treatment - run the below code for each treatment type 
#	code is currently set up for "UV" treatments
#	CO2, invasion, N, NCO2, NP, Ozone, P, UV, Warming
s1=subset(prod,prod$factor=="UV")
s1
