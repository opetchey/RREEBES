#Draw Figure 1 (productivity) & 2(decomposition) as one and two panels, respectively
#EC Adair 2012
...
#Productivity data
 #Diversity
 powInfo <- read.csv("C:\\Users\\carol\\Desktop\\carol\\NCEAS\\Cardinale WG\\Relative importance\\Draft\\Nature Revisions\\Figure Code\\Fig1&2\\PowerCoeffs_Prod_min.csv", check.names=FALSE)
 head(powInfo)
 #Other effects
 prod.other <- read.csv("C:\\Users\\carol\\Desktop\\carol\\NCEAS\\Cardinale WG\\Relative importance\\Draft\\Nature Revisions\\Figure Code\\Fig1&2\\Prod_OtherFactors.csv", check.names=FALSE)
 head(prod.other)

#Decomposition data
# consumer and litter diversity
 powInfoCons <- read.csv("C:\\Users\\carol\\Desktop\\carol\\NCEAS\\Cardinale WG\\Relative importance\\Draft\\Nature Revisions\\Figure Code\\Fig1&2\\PowerCoeffs_ConsumDivDecomp_min.csv", check.names=FALSE)
 powInfoLitt <- read.csv("C:\\Users\\carol\\Desktop\\carol\\NCEAS\\Cardinale WG\\Relative importance\\Draft\\Nature Revisions\\Figure Code\\Fig1&2\\PowerCoeffs_LitterDivDecomp_min.csv", check.names=FALSE)
 head(powInfoCons)
 head(powInfoLitt)
 #Other effects
 decomp.other <- read.csv("C:\\Users\\carol\\Desktop\\carol\\NCEAS\\Cardinale WG\\Relative importance\\Draft\\Nature Revisions\\Figure Code\\Fig1&2\\Decomp_OtherFactors.csv", check.names=FALSE)
 head(decomp.other)
...
###########################
#make FIG ONE - PRODUCTIVITY
#As a pdf 
pdf("C:\\Users\\carol\\Desktop\\carol\\NCEAS\\Cardinale WG\\Relative importance\\Draft\\Nature revisions\\Figure Code\\Fig1&2\\Fig1.pdf", 
...
###########################
#make FIG TWO - DECOMPOSITION
# as a pdf file

pdf("C:\\Users\\carol\\Desktop\\carol\\NCEAS\\Cardinale WG\\Relative importance\\Draft\\Nature revisions\\Figure Code\\Fig1&2\\Fig2.pdf", 
