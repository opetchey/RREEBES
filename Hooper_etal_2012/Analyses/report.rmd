...
# path_data <- getwd()
# 
# powInfo <- read.csv(paste0(path_data,"/data/","PowerCoeffs_Prod_min.csv"), check.names=FALSE) 
# head(powInfo)
# prod.other <- read.csv(paste0(path_data,"/data/","Prod_OtherFactors.csv"), check.names=FALSE)
# head(prod.other)
# powInfoCons <- read.csv(paste0(path_data,"/data/","PowerCoeffs_ConsumDivDecomp_min.csv"), check.names=FALSE)
# powInfoLitt <- read.csv(paste0(path_data,"/data/","PowerCoeffs_LitterDivDecomp_min.csv"), check.names=FALSE)
# head(powInfoCons)
# head(powInfoLitt)
# decomp.other <- read.csv(paste0(path_data,"/data/","Decomp_OtherFactors.csv"), check.names=FALSE)
# head(decomp.other)
...
# Reproducing Table 1: 
```{r table}
# NS <- powInfoCons[which(powInfoCons$FinalT=="Y"),]
```
